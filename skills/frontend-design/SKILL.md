...
Focus on:
- **Spatial Composition**: Unexpected layouts. Diagonal flow. Grid-breaking elements. Generous negative space OR controlled density.
...
- NEVER create floating/overlapping cards/elements around the hero image, even if they serve a purpose
