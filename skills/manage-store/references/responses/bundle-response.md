...
interface Bundle {
  ...
  rulesets?: BundleRuleset[]; // expandable
  plans?: BundlePlan[]; // expandable (supports plans.variant, plans.plan)
  preferences?: BundlePreference[]; // expandable
  filters?: BundleFilter[]; // expandable
  discounts?: BundleDiscount[]; // expandable
  prices?: BundlePrice[]; // expandable
  tags: string[];
  published: boolean;
  createdAt: string;
  updatedAt?: string;
...
interface BundlePlan {
  ...
  pricing?: Plan | null; // @deprecated → use plan
  pricings?: Plan[] | null; // @deprecated → always returns null
  variants?: Variant[] | null; // @deprecated → always returns null
  products?: (Plan | Variant)[] | null; // @deprecated → use plan or variant
  createdAt: string;
  updatedAt?: string;
}
...
interface BundlePreference {
  id: number;
  title: string;
  attributeId?: number; // @deprecated → use metafieldId
  metafieldId: number;
