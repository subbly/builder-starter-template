...
- `bundles/create.js <json[params/bundles/create.yaml]>`
- `bundles/update.js <json[params/bundles/update.yaml]>`
- `bundles/publish.js <json[params/bundles/publish.yaml]>`
- `bundles/unpublish.js <json[params/bundles/unpublish.yaml]>`
...
- `bundles/items/create.js <json[params/bundles/items/create.yaml]>`
- `bundles/items/update.js <json[params/bundles/items/update.yaml]>`
...
- `bundles/plans/update.js <json[params/bundles/plans/update.yaml]>`
- `bundles/plans/archive.js <json[params/bundles/plans/archive.yaml]>`
